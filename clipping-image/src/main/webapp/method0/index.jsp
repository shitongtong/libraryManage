...
<title>demo</title>
<link rel="stylesheet" href="<c:url value="/method0/jcrop/css/jquery.Jcrop.css"/>" type="text/css"/>
<script type="text/javascript" src="<c:url value="/method0/jcrop/js/jquery.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="/method0/jcrop/js/jquery.Jcrop.js"/>"></script>
</head>
<body>
