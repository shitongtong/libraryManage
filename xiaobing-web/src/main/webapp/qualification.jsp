    ...
    <div class="left-side sticky-left-side">
        ...
        <div class="left-side-inner">
            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="active"><a href="/app/qualification"><i class="fa fa-envelope"></i> <span>实名认证</span></a></li>
                          ...
                          <header class="panel-heading">
                           	...
                           	<div class="panel-body">
                           		  <form class="form-horizontal" role="form">
                           		  	<div class="row">
                           		  		<div class="col-md-7 col-sm-11 col-xs-7">
                           		  	   <div class="form-group">
                                      <label>认证状态：</label>
                                      <label style="color: red;">${bQualificate}</label>
                                     </div>
                                     
                                     <div class="form-group">
                                      <label>真实姓名：</label>
                                      <input style="max-width: 350px;" class="form-control" id="name" value="${Qualificate_Name}"/>
                                     </div>
                                     
                                     <div class="form-group">
                                      <label>身份证号码：</label>
                                      <input style="max-width: 350px;" class="form-control" id="number" value="${Qualificate_Number}"/>
                                     </div>
                                     ...
                                     <div class="form-group">
                                      <label>持证照片：</label>
                           		  	...
                           		  	<div class="col-md-5 col-sm-1 col-xs-5">
                           		  		<img src="/images/exp.png"/>
                           		  		
                           		  	</div>
                           		  	</div>
                           		  	
                           		  	<div style="color: rosybrown; font-size: 0.7em;">
                           		  		所提交的身份证明文件必须与所选择的证件类型相符；<br />
                                                                                                            所填写的真实姓名及证件号码必须准确无误；<br />
                                                                                                            建议使用二代身份证；<br />
                                                                                                            照片须免冠，手持证件必须看清证件号码且证件完整；<br />
                                                                                                             照片必须是原始照片，不得使用任何软件进行修改；<br />
                                                                                                             认证通过后将不可再修改，如有修改请联系客服；<br />
                           		  	</div>
                           	</div>
