...
public class PokerShuffleCards {
    public static void main(String[] args) {
        ...
        System.out.println("玩家11：" + eliminate(sPlayer));
        System.out.println("玩家22：" + eliminate(sPlayer2));
        System.out.println("玩家33：" + eliminate(sPlayer3));
        System.out.println("底牌：" + sSecretCards);
    }

    public static List<String> eliminate(List<String> sPlayer) {
        List<String> cList = new ArrayList<>();
        List<String> nList = new ArrayList<>();
        for (String s1 : sPlayer) {
