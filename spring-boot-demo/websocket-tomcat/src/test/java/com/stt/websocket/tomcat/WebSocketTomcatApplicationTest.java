...
@SpringBootTest(classes = WebSocketTomcatApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
@DirtiesContext
public class WebSocketTomcatApplicationTest {
    private static Log logger = LogFactory.getLog(WebSocketTomcatApplicationTest.class);
