...
//        PropertiesLoader prop = new PropertiesLoader("config/dev.properties");
...
//        String port = prop.getProperty("redis.port");
        ...
        if (instance == null) {
            synchronized (LOCK) {
                if (instance == null) {
//                    instance = new RedisUtil("10.172.204.197",19000);
//                    instance = new RedisUtil("192.168.0.100",6379);
                    instance = new RedisUtil(host, Integer.parseInt(port),password);
                }
            }
        }
...
//            config.setMaxWait(1000 * 100);
            ...
            pool = new JedisPool(config, ip, prot, 100000,password,5);
        }
    }
...
//            res = jedis.zadd(key, scoreMembers);
    ...
    /*public static void main(String[] args){
        RedisUtil util  =new RedisUtil("192.168.0.100",6379);
        AdminVo vo = new AdminVo();
        vo.setAdminId("1");
        vo.setName("admin");
        String string = JSONObject.toJSONString(vo);
        System.out.println(util.setex("k1","v1",7200));
        System.out.println(util.get("k1"));
        System.out.println(util.setex("qq",string,1000));
        System.out.println(util.get("qq"));
    }*/
}
